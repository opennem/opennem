 ...
 * `opennem-fe` - [GitHub](https://github.com/opennem/opennem-fe) - This is the web frontend for OpenNEM written in Javascript and powering the [OpenElectricity tracker website](https://explorer.openelectricity.org.au)
