---
title: 'Data Limits'
description: 'Documentation for the OpenElectricity REST API - Data Range Limits'
icon: 'circle-stop'
---

<Notice>
These limits are currently under review and may be increased in the future.
</Notice>
...
|----------|--------------|-------------|
| 5-minute (`interval`) | 7 days | High-resolution 5-minute interval data |
| Hourly (`hour`) | 30 days | Hourly aggregated data |
| Daily (`day`) | 365 days | Daily aggregated data |
| Weekly (`week`) | 365 days | Weekly aggregated data |
