...
def patches():
    ...
    sqls = [
        "update wem_facility set capacity_credits = 2.0 where code = 'GOSNELLS'",
        ...
        "update nem_facility set station_id = (select id from nem_station where name = 'Wivenhoe Small') where code ='WIVENSH'",
        "update nem_station set name_clean = 'Wivenhoe Mini' where name = 'Wivenhoe Small'",
