...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "station_id", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "facility_id", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "is_update", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "approved", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "approved_by", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "approved_at",
            postgresql.TIMESTAMP(timezone=True),
        ...
        sa.Column(
            "approved_comment", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "discarded", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "discarded_by", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "discarded_at",
            postgresql.TIMESTAMP(timezone=True),
