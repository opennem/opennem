...
class AggregateNetworkFueltechIntervals(Base, BaseModel):
    """
    Network Fueltech Intervals Aggregate
    """

    __tablename__ = "at_network_fueltech_intervals"

    trading_interval = Column(TIMESTAMP(timezone=True), index=True, primary_key=True, nullable=False)

    network_id = Column(
        Text,
        ForeignKey("network.code", name="fk_at_network_fueltech_intervals_network_code"),
        primary_key=True,
        index=True,
        nullable=False,
    )
    ...
    fueltech_id = Column(Text, nullable=False, primary_key=True)
    ...
    __table_args__ = (
        Index("idx_at_network_fueltech_intervals_network_id_interval", network_id, trading_interval.desc()),
        Index(
